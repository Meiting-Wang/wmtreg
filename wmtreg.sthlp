...
. {stata reg price mpg headroom}{break}
. {stata est store m1}{break}
. {stata reg price mpg trunk headroom}{break}
. {stata est store m2}{break}
. {stata reg price mpg trunk headroom rep78_num*}{break}
. {stata est store m3}{break}
. {stata reg price mpg trunk headroom foreign rep78_num*}{break}
